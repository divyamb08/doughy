        ...
        <div className="signup">
            ...
            <form
                ...
                onSubmit={(e) => {
                    ...
                    add_user({
                        variables: { username: signupUsername, password: signupPassword, email: signupEmail, firstName: signupFirstName, lastName: signupLastName },
                        onError: (error) => {
                            if (error.message.includes("UNIQUE")) {
                                setUsernameTryAgain(true);
                            }
                            for (const field of Object.keys(fieldToState)) {
                                if (error.message.includes(field) & !error.message.includes("UNIQUE")) {
            ...
            <div className="signup-login"> Already have an account? <a href="url" className="signup-login-url"> Login here! </a> </div>
        </div>
    )
}
